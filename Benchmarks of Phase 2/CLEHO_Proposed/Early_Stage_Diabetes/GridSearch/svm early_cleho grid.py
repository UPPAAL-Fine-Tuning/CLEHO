...
model_name = 'SVM_RBF_GridSearch_Diabetes_Augmented'

print(f"\n{'='*60}")
print(f"  Starting DENSE Grid Search for {model_name}...")
print(f"  Using {X_train.shape[1]} features (including Cluster Label)")
...
print(f" Features Processed        : {X_train.shape[1]}")
print("-" * 60)
