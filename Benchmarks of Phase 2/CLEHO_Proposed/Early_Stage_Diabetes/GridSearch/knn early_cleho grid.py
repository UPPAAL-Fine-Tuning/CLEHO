...
model_name = 'KNN_GridSearch_Diabetes_Augmented'

print(f"\n{'='*60}")
print(f" Starting Grid Search for {model_name}...")
print(f" Using {X_train.shape[1]} features (63 original + cluster)")
...
print(f"  Total Features Processed  : {X_train.shape[1]}")
print("-" * 60)
