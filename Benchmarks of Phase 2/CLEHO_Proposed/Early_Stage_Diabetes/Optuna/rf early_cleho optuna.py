...
train_filename = 'diabetes_augmented_train.csv'
test_filename = 'diabetes_augmented_test.csv'
...
print(f" Data loaded from {train_filename}")
...
print(f"\n  Starting Optuna for Cluster-Augmented Data ({X_train.shape[1]} features)...")
...
print("\n" + "█"*60)
print(f"  PERFORMANCE REPORT: RF (CLUSTER-AUGMENTED DIABETES)")
print("█"*60)
